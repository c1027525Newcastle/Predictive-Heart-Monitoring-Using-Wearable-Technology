...
data_name = 'gru_model_3_5000_250_5'
ml_model = 'ML_Models/gru_model_3_data5000_epoch250_sequence5_NormalisationTRUE_full.pth' 
...
df['sport'] = df['sport'].astype('category').cat.codes  # Encode the sport column
